...
app.config['SECRET_KEY'] = 'any-мукн-дщтп-secret-key-you-choose'
...
def register():
    if request.method == "POST":
        ...
        # The format for the hashed string looks like this: method$salt$hash
        new_user = User(
...
def login():
    if request.method == "POST":
        ...
        # print(user.email, check_password_hash(user.password, password))
